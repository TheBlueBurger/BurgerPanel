...
export const _ServerPermissions = ["set.autostart", "set.autorestart", "set.port", "set.software", "set.mem", "set.name", "set.allowedUsers.add", "set.allowedUsers.remove", "set.allowedUsers.permissions.write", "console.read", "console.write", "status", "stop", "start", "kill", "delete", "oldlogs.read", "serverfiles.read", "full"] as const;
export const _ServersPermissions = [
    "create",
    "import",
    "all.view"
] as const;
export const _UserPermissions = ["create", "view", "set.admin", "token.read", "token.reset", "delete", "permissions.read", "permissions.write", "password.change", "username.change"] as const;
