...
export const _ServerPermissions = ["set.autostart", "set.autorestart", "set.port", "set.software", "set.mem", "set.name", "set.allowedUsers.add", "set.allowedUsers.remove", "set.allowedUsers.permissions.write", "console.read", "console.write", "status", "stop", "start", "kill", "delete", "oldlogs.read", "full"] as const;
